...
<body class="easyui-layout">
	...
	<div style="float: right;width:70%"  >
 	   ...
 	   <form id="roleForm" method="post"  action="${ctx}/role/add" >
				<input type="hidden" name="resourceIds"  id="resourceIds" />
				<table border="0" cellspacing="0" cellpadding="0" class="add_tab"
					frame="border" style="width: 100%">
					<tr>
						<th width="30%">角色名：</th>
						<td width="70%">
						<input class="easyui-textbox" type="text"  name="name" data-options="required:true" width="200px"> </input>
						</td>
					</tr>
					<tr>
						<th>角色标签：</th>
						<td><input class="easyui-textbox" type="text" name="label" data-options="required:true" width="200px"> </input></td>
					</tr>
					<tr>
						<th>描述:
						</td>
						<td><input class="easyui-textbox" name="description" data-options="multiline:true" style="height: 60px; width: 200px"></input>
						</td>
					</tr>
				</table>
			</form>
